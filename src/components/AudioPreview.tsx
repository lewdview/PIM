...
// Optimization: Extract time display to prevent the parent AudioPreview
// component from re-rendering on every timeupdate tick (2Hz).
function AudioPreviewTimeDisplay({
  isThisTrack,
  isFullSong,
  durationLabel,
  isPlaying,
...
// Optimization: Extract progress bar to isolate the high-frequency
// Zustand subscription (progress) to this small component only.
function AudioPreviewProgressBar({
  isThisTrack,
  isPlaying,
  isFullSong,
}: {
    ...
    <div className="space-y-1" onClick={(e) => e.stopPropagation()}>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <AudioPreviewProgressBar isThisTrack={isThisTrack} isPlaying={isPlaying} isFullSong={isFullSong} />
          {tierLabel && (
        ...
        <AudioPreviewTimeDisplay isThisTrack={isThisTrack} isFullSong={isFullSong} durationLabel={durationLabel} isPlaying={isPlaying} />
      </div>
