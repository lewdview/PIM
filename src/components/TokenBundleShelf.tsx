...
const BUNDLE_TIERS: BundleTierConfig[] = [
  {
    ...
    targetedPullsLabel: 'Towards 275 V⚡ Day Pull',
  ...
  },
  {
    ...
    targetedPullsLabel: '4 Targeted Day Pulls',
    popular: true,
  ...
  },
  {
    ...
    targetedPullsLabel: '9 Targeted Day Pulls',
    bestValue: true,
  ...
  },
  {
    ...
    targetedPullsLabel: '25 Targeted Day Pulls',
    whale: true,
