...
// Extracted component to prevent massive re-renders on the parent component
const GlobalProgressBar = ({ accent }: { accent: string }) => {
...
// Extracted component to prevent massive re-renders on the parent component
const GlobalTimeDisplay = ({ limit }: { limit: number }) => {
