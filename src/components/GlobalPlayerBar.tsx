...
// Extracted high-frequency components (ProgressBar and Time) to prevent the main
// GlobalPlayerBar component from re-rendering on every timeupdate event (60fps).
// Granular selectors ensure only these small components re-render when progress changes.
...
function GlobalPlayerTime({ effectiveDuration }: { effectiveDuration: number }) {
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              <GlobalPlayerTime effectiveDuration={effectiveDuration} />
              {isPreview && (
                <span style={{
                  fontFamily: '"JetBrains Mono", monospace',
                  fontSize: '7px',
