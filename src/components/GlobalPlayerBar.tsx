...
// Extracted high-frequency state components
...
function TimeDisplay({ isPreview, effectiveDuration }: { isPreview: boolean, effectiveDuration: number }) {
...
export default function GlobalPlayerBar() {
  ...
  // Granular selectors to prevent massive re-renders
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              <TimeDisplay isPreview={isPreview} effectiveDuration={effectiveDuration} />
            </div>
          </div>
