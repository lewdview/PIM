...
export default function GlobalPlayerBar() {
  ...
  // Granular selectors to prevent unnecessary re-renders of the entire bar container when possible
  // Note: progress and currentTime update frequently, but it's acceptable for this specific component
  // to re-render as its primary purpose is displaying the time updates.
