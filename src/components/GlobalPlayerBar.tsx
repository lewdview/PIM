...
// ⚡ Bolt: Extracted high-frequency updating components to prevent parent re-renders
const PlayerProgressBar = ({ accent, onSeek }: { accent: string; onSeek: (e: React.MouseEvent<HTMLDivElement>) => void }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <PlayerProgressBar accent={accent} onSeek={handleSeek} />
