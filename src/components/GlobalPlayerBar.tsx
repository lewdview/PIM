...
// Extracted component to isolate rapid progress updates
function GlobalProgressBar({ accent }: { accent: string }) {
...
// Extracted component to isolate rapid currentTime updates
function GlobalTimeDisplay({ effectiveDuration }: { effectiveDuration: number }) {
...
export default function GlobalPlayerBar() {
  ...
  // Only subscribe to properties that change infrequently
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <GlobalProgressBar accent={accent} />
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              <span style={{
                ...
                <GlobalTimeDisplay effectiveDuration={effectiveDuration} />
              </span>
              {isPreview && (
                <span style={{
                  fontFamily: '"JetBrains Mono", monospace',
