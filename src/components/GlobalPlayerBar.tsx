...
// Extracted component to prevent massive re-renders of GlobalPlayerBar on every progress update
const PlayerProgressBar = ({ accent }: { accent: string }) => {
...
// Extracted component for time display to prevent massive re-renders
const PlayerTimeDisplay = ({ effectiveDuration }: { effectiveDuration: number }) => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <PlayerProgressBar accent={accent} />
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
            ...
            <div style={{
              ...
              <PlayerTimeDisplay effectiveDuration={effectiveDuration} />
              {isPreview && (
                <span style={{
                  fontFamily: '"JetBrains Mono", monospace',
                  fontSize: '7px',
