    ...
    <div className="flex-shrink-0 flex flex-col items-center" style={{ width: `${CARD_W}px` }}>
      ...
      <div className="relative w-full overflow-hidden" style={{
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex items-center justify-center" style={{ background: 'rgba(6,3,14,0.96)' }}>
          ...
          {/* VIBRANT POPPING PACK ACCENT COLOR TINT (Rich pack color pop on top) */}
          <div
        ...
        {/* METALLIC NOISE TEXTURE (Micro-Fine Refined) */}
        <div className="absolute inset-0 pointer-events-none mix-blend-overlay" style={{
          background: `url("data:image/svg+xml,%3Csvg viewBox='0 0 128 128' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='4.5' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)'/%3E%3C/svg%3E")`,
          opacity: 0.08,
          zIndex: 2,
        }} />
