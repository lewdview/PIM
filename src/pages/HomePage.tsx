  ...
  return (
    <div className="flex-1 w-full pb-36 md:pb-8">
      ...
      <section className="relative">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 pt-3 pb-8 lg:pt-4 lg:pb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              <div className="border border-black p-4 flex flex-col justify-between relative overflow-hidden" style={{ background: 'linear-gradient(180deg, rgba(255,215,0,0.06) 0%, rgba(255,153,0,0.02) 100%)', border: '2px solid rgba(255,215,0,0.3)' }}>
                <div className="absolute top-2 right-2">
                  <span className="text-[8px] font-mono font-black uppercase px-1.5 py-0.5 rounded bg-amber-500/20 text-amber-300 border border-amber-500/40">
                    ✦ 3% MYTHIC
                  </span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <button 
                    ...
                    className="w-full py-2 bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-black font-black uppercase text-xs tracking-wider transition-all disabled:opacity-30 active:scale-[0.98] cursor-pointer"
              ...
              <div className="border border-black p-4 flex flex-col justify-between relative overflow-hidden" style={{ background: 'linear-gradient(180deg, rgba(255,20,147,0.08) 0%, rgba(50,10,30,0.4) 100%)', border: '2px solid rgba(255,20,147,0.35)' }}>
                ...
                <div>
                  ...
                  <button 
                    ...
                    className="w-full py-2 bg-gradient-to-r from-pink-500 to-rose-500 hover:from-pink-400 hover:to-rose-400 text-white font-black uppercase text-xs tracking-wider transition-all disabled:opacity-30 active:scale-[0.98] cursor-pointer"
                    style={{ border: '2px solid #000', boxShadow: '2px 2px 0 #000' }}
                  >
