  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (typeof crypto === 'undefined' || !crypto.subtle) {
        // Fallback or error if crypto API is unavailable
      ...
      if (hashHex === ADMIN_PASSPHRASE_HASH) {
        ...
        // SECURITY: Store the plaintext passphrase temporarily for backend auth sync
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                const passphrase = sessionStorage.getItem('th3vault_admin_passphrase') || 'fallback_if_unauthenticated';
