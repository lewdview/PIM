...
// ===== ADMIN GATE =====
const ADMIN_HASH = 'd58f380b169d36c2fe217dadc3caa620193197132b55ba52b0947882b78c4983';
...
function AdminGate({ onAuthenticate }: { onAuthenticate: () => void }) {
  ...
  // Security Note: Hardcoding the hash avoids exposing the plaintext password in the bundle.
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (hashHex === ADMIN_HASH) {
        ...
        // Cache plaintext passphrase required for backend API invocations (like config push)
